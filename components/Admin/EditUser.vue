                    ...
                    <tbody>
                        <template v-for="page in pages" :key="page.id">
                            <tr class="parent-permission bg-gray-50">
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        v-model="
                                            rolePermissions[page.id].Publish
                                        "
                                        class="mx-auto"
                                    />
                                </td>
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        v-model="
                                            rolePermissions[page.id].Delete
                                        "
                                        class="mx-auto"
                                    />
                                </td>
                            ...
                            <tr
                                ...
                                :key="child.id"
                                class="child-permission bg-gray-50"
                            >
                                <td
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        v-model="
                                            rolePermissions[child.id].Publish
                                        "
                                        class="mx-auto"
                                    />
                                </td>
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        v-model="
                                            rolePermissions[child.id].Delete
                                        "
                                        class="mx-auto"
                                    />
                                </td>
