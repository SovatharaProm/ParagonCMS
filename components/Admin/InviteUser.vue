        ...
        <v-container>
            <v-row>
                <v-col>
                    <label
                        for="email"
                        class="block text-md font-bold mb-2 text-blue-900"
                        >Email:</label
                    >
                    <input
                        type="email"
            ...
            <h2 class="font-bold text-blue-900 text-xl mt-6 mb-4">
                User Level
            </h2>
            <v-row class="flex-wrap mb-6">
                <v-col
                    v-for="level in displayedUserLevels"
                    :key="level"
                    class="w-1/2 md:w-1/3 lg:w-1/4 mb-4"
                >
                    <label
            ...
            <template v-if="isSuperAdmin">
                <h2 class="font-bold text-blue-900 text-xl mb-4">
                    Permissions
                </h2>
                <div class="overflow-x-auto">
                    ...
                    >
                        <thead>
                            <tr>
                                <th
                                    class="px-6 py-3 border-b border-gray-200 bg-gray-100 text-left text-sm leading-4 font-medium text-gray-700 uppercase tracking-wider"
                                >
                                    Permissions
                                </th>
                                <th
                                    ...
                                    :key="permission"
                                    class="px-6 py-3 border-b border-gray-200 bg-gray-100 text-center text-sm leading-4 font-medium text-gray-700 uppercase tracking-wider"
                                >
                                    {{ permission }}
                                </th>
                            </tr>
                        ...
                        <tbody>
                            <template v-for="page in pages" :key="page.id">
                                ...
                                >
                                    <td
                                        class="px-6 py-4 border-b border-gray-200 pl-10"
                                    >
                                        {{ child.page_name }}
                                    </td>
                                    <td
            ...
            <div class="flex justify-end mt-6">
                <button
                    class="bg-gray-500 text-white font-bold px-4 py-2 rounded-lg mr-4"
                    @click="cancel"
                >
                    Cancel
                </button>
                <button
                    class="bg-blue-900 text-white font-bold px-4 py-2 rounded-lg"
                    @click="sendInvite"
                >
                    Send Invite
                </button>
